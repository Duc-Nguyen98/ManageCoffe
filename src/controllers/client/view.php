                        ...
                        echo '<div class="row">
                                <div class="col-4">
                                    ...
                                    <div data-mdb-input-init class="form-outline">
                                        <input type="email" id="form8Example2" class="form-control " value="' . $email . '"  />
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="form-outline" data-mdb-input-init >
                                        <input type="email" id="typeEmail" class="form-control "  value="' . $name . '" />
                                ...
                                <div class="col-4">
                                    <!-- Email input -->
                                    <div data-mdb-input-init class="form-outline">
                                        <input type="email" id="form8Example2" class="form-control " value="' . $role_name . '"  />
