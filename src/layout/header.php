...
<head>
    ...
    <!-- MDB icon -->
    <link rel="icon" href="https://cdn.haitrieu.com/wp-content/uploads/2021/11/Logo-DH-Thu-Do-Ha-Noi-HNMU.png" type="image/x-icon" />
    <!-- Font Awesome -->
    ...
    <header>
        ...
        <nav id="main-navbar" class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
            ...
            <div class="container-fluid">
                ...
                <img src="https://i.pinimg.com/736x/b3/49/28/b3492812df22600add213540ad43a53a.jpg" style="width: 45px;height: 45px;" alt="HNMU Logo" loading="lazy" />                    <h4 class="text-muted mb-0 ms-2"><b>HNMU Coffee</b></h4>
                </a>
