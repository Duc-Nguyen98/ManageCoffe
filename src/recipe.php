                ...
                <div class="card text-center">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="exportAction">
                            <a href="<?php echo $base_url; ?>controllers/recipe/create.php" class="btn btn-primary"
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_assoc($rows)) {
                                    ...
                                    <tr id="<?= $row['id']; ?>" class="text-start fw-bold">
                                        ...
                                        <td><span data-mdb-tooltip-init data-mdb-placement="bottom" title="Ấn nút xanh, để xem chi tiết!"> <?= truncateText($row['note']) ?></span></td>
                                        ...
                                        <td>
                                            <a href="<?php echo $base_url; ?>controllers/recipe/view.php?id=<?= $row['id']; ?>"
                                                class="btn btn-link btn-rounded btn-sm fw-bold bg-info bg-gradient text-white"
                                                data-mdb-ripple-color="dark">
                                                <i class="fas fa-eye fa-lg"></i>
                                            </a>
                                            <a href="<?php echo $base_url; ?>controllers/recipe/edit.php?id=<?= $row['id']; ?>"
