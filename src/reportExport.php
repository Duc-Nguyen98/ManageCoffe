                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        <div class="input-group">
                                            ...
                                            <button type="button" class="btn btn-outline-primary"
                                                data-mdb-ripple-init>Tìm kiếm</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3 d-flex justify-content-end">
                                        <div class="exportAction">
                                            <nav data-mdb-sidenav-init id="sidenav-1" class="sidenav"
                                                data-mdb-hidden="true" data-mdb-right="true">
                                                <ul class="sidenav-menu">
                                                    ...
                                                    <li class="sidenav-item">
                                                        <a class="sidenav-link"><i
                                                                class="fas fa-grin fa-fw me-3"></i><span>Category
                                                                1</span></a>
                                                    </li>

                                                    <li class="sidenav-item">
                                                        <a class="sidenav-link"><i
                                                                class="fas fa-grin-wink fa-fw me-3"></i><span>Category
                                                                2</span></a>
                                            ...
                                            <button data-mdb-ripple-init data-mdb-toggle="sidenav"
                                                data-mdb-target="#sidenav-1" class="btn btn-secondary"
                                                aria-controls="#sidenav-1" aria-haspopup="true">
                                                <i class="fa-solid fa-filter"></i> Bộ lọc
                                            </button>
                                            <button type="button" class="btn btn-success" data-mdb-ripple-init
                                                id="downloadexcel"><i class="fas fa-file-excel fa-lg"></i>
                                                Excel</button>
                                            <button type="button" class="btn btn-danger" data-mdb-ripple-init
                                                id="dl-pdf"><i class="far fa-file-pdf fa-lg"></i> PDF</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="row">
                                                ...
                                                <!-- Thêm một cột trống để căn chỉnh -->
                                                <div class="col-md-3 mb-3 d-flex justify-content-end">
                                                    <div class="exportAction">
                                                        <!--Filter-->
                                                        <nav data-mdb-sidenav-init id="sidenav-1" class="sidenav"
                                                        ...
                                                        <button type="button" class="btn btn-success"
                                                            data-mdb-ripple-init name="export_excel"
                                                            id="downloadexcel"><i class="fas fa-file-excel fa-lg"></i>
                                                            Excel</button>
                                                        <button type="button" class="btn btn-danger"
                                                            data-mdb-ripple-init><i class="far fa-file-pdf fa-lg"></i>
                                                            PDF</button>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <tr id="<?= $row['id']; ?>" class="text-start fw-bold">
                                                        ...
                                                        <td>
                                                            <p class="fw-normal mb-1"><b>
                                                                    <?= formatCurrency($row['total_sale_price']) ?> </b></p>
                                                        </td>
                                                        <td>
                                                            <p class="fw-normal mb-1"><b>
                                                                    <?= formatCurrency($row['transport']) ?> </b></p>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <p class="fw-normal mb-1"><b>
                                                                    <?= formatCurrency($final_value) ?> </b></p>
                                                        </td>
